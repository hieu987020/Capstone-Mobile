...
class ScreenCameraSearch extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: CameraSearchForm(),
...
// //! Camera : Search Form
class CameraSearchForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class CameraSearchContent extends StatefulWidget {
  @override
  _CameraSearchContentState createState() => _CameraSearchContentState();
}

class _CameraSearchContentState extends State<CameraSearchContent> {
  @override
  Widget build(BuildContext context) {
    List<Camera> cameras;
